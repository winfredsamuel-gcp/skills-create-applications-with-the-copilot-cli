...
<img width="60%" height="60%" alt="CopilotCLI" src="https://github.com/winfredsamuel-gcp/skills-create-applications-with-the-copilot-cli/blob/main/.github/images/copilot-cli.png?raw=true" />
...
<img width="60%" height="60%" alt="CopilotCLIAddDir" src="https://github.com/winfredsamuel-gcp/skills-create-applications-with-the-copilot-cli/blob/main/.github/images/copilot-cli-add-directory.png?raw=true" />
<br />
<img width="60%" height="60%" alt="CopilotCLITerminalBindings" src="https://github.com/winfredsamuel-gcp/skills-create-applications-with-the-copilot-cli/blob/main/.github/images/copilot-cli-terminal-bindings.png?raw=true" />
...
<img width="60%" height="60%" alt="CopilotCLIPerms" src="https://github.com/winfredsamuel-gcp/skills-create-applications-with-the-copilot-cli/blob/main/.github/images/copilot-cli-permissions.png?raw=true" />
